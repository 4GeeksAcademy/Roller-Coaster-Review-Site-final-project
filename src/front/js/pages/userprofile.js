...
export const UserProfile = () => {
    ...
    const getUser = () => {
        if (Object.keys(profile).length > 0) setProfile({})
    ...
    console.log(profile)
    return (
        <div className="container mb-4 min-vh-100">
            <div className="userprofile-container">
                <div className="userinfo">
                    ...
                    <div>
                        <h2 className="ms-1">{profile.username}</h2>
            ...
            <div className="park-review-container review-container">
                ...
                {!profile.park_reviews || profile.park_reviews.length === 0 ? <h4>No Reviews Written Here...</h4> : (
                    profile.park_reviews.map((review, idx) => {
                        return (
                            <div key={idx} className="mb-3">
                                <div className="review-top d-flex justify-content-between">
                                    ...
                                    <div className="review-top-text d-flex align-items-center">   
            ...
            <div className="park-review-container review-container">
                <div className="park-review">
                    ...
                    {!profile.coaster_reviews || profile.coaster_reviews.length === 0 ? <h4>No Reviews Written Here...</h4> : (
                        profile.coaster_reviews.map((review, idx) => {
                            return (
                                <div key={idx}>
                                    <div className="review-top d-flex justify-content-between">
                                        <div>
